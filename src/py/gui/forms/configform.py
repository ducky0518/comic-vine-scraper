...
class ConfigForm(CVForm):
   ...
   def __init__(self, owner):
      ...
      ConfigForm.__DESCRIPTION_CB = i18n.get("ConfigFormDescriptionCB")        
   ...
   def __build_detailstab(self):
      ...
      self.__update_checklist.Items.Add(ConfigForm.__DESCRIPTION_CB)        
   ...
   def __get_configuration(self):
      ...
      config.update_description_b = is_checked(ConfigForm.__DESCRIPTION_CB)        
   ...
   def __set_configuration(self, config):
      ...
      set_checked(ConfigForm.__DESCRIPTION_CB, config.update_description_b)        
